Trong bài tập lớn này em có sử dụng Markdown để vẽ các sơ đồ và bảng (file .md) cùng với 2 công cụ là Mermaid và PlantUML (có thể tự động render trong github). 
